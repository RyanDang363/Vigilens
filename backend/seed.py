...
db.add_all([
    make_finding(
        ...
        reasoning="Observations ['cross_contamination'] indicate raw-to-RTE cross-contamination without visible sanitation between tasks.",
    ...
    make_finding(
        ...
        reasoning="Observations ['hand_wash_short'] indicate handwashing was insufficient before food contact.",
...
db.add_all([
    make_finding(
        ...
        reasoning="Observations ['food_dropped'] indicate food fell to the floor and was placed back on the prep surface without discarding.",
    ...
    make_finding(
        ...
        reasoning="Observations ['bare_hand_rte'] indicate the employee handled ready-to-eat food without gloves or utensils.",
...
db.add_all([
    make_finding(
        ...
        policy_short_rule="Protect food from cross-contamination using separation, storage, and preparation controls.",
        policy_url="https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=HSC&sectionNum=113986.",
        reasoning="Observations ['cross_contamination'] indicate the employee cut raw chicken and then immediately began slicing tomatoes on the same board without sanitizing.",
        training_recommendation="Sanitize the food-contact surface and wash hands before switching from raw to ready-to-eat items.",
    ...
    make_finding(
        ...
        policy_short_rule="Wash hands with cleanser and warm water for 10 to 15 seconds at required times.",
        policy_url="https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=HSC&sectionNum=113953.3",
        reasoning="Observations ['hand_to_face'] indicate employee touched face and resumed food handling without washing hands.",
        training_recommendation="Wash hands thoroughly for at least 20 seconds before handling food, after touching your face, and when switching tasks.",
    ...
    make_finding(
        ...
        policy_url="",
        reasoning="Observations ['utensil_dropped'] indicate a spatula fell to the floor and was picked up and used again without washing.",
